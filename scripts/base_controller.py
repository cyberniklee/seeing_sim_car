...
class BaseController:
    def __init__(self, arduino, base_frame):
        ...
        pid_params = dict()
        pid_params['wheel_diameter'] = rospy.get_param("~wheel_diameter", 0.068) 
        pid_params['wheel_track'] = rospy.get_param("~wheel_track", 0.265)
        pid_params['encoder_resolution'] = rospy.get_param("~encoder_resolution", 16) 
        pid_params['gear_reduction'] = rospy.get_param("~gear_reduction", 62)
